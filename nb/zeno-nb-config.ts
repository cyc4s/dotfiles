...
// zeno.zsh 用の nb 補完・スニペット設定
// 依存: zeno.zsh (https://github.com/yuki-yano/zeno.zsh)
...
//   // nb snippets
//   const snippets = [
//     { name: "nb add bookmark",       keyword: "nbb",    snippet: "nb add --type bookmark" },
//     { name: "nb add todo",           keyword: "nbt",    snippet: "nb add --type todo --title" },
//     { name: "nb add folder",         keyword: "nbf",    snippet: "nb add --type folder" },
//     { name: "nb search",             keyword: "nbs",    snippet: "nb search" },
//     { name: "nb edit",               keyword: "nbe",    snippet: "nb edit" },
//     { name: "nb list",               keyword: "nbl",    snippet: "nb ls --limit 20" },
//     { name: "nb list all",           keyword: "nbla",   snippet: "nb ls --all" },
//     { name: "nb list todos",         keyword: "nblt",   snippet: "nb ls --type todo" },
//     { name: "nb list bookmarks",     keyword: "nblb",   snippet: "nb ls --type bookmark" },
//     { name: "nb git status",         keyword: "nbg",    snippet: "nb git status" },
//     { name: "nb git commit",         keyword: "nbgc",   snippet: "nb git add . && nb git commit -m" },
//     { name: "nb sync",               keyword: "nbsync", snippet: "nb sync" },
//     { name: "nb browse",             keyword: "nbbr",   snippet: "nb browse" },
//     { name: "nb notebooks list",     keyword: "nbn",    snippet: "nb notebooks" },
//     { name: "nb use notebook",       keyword: "nbu",    snippet: "nb use" },
//     { name: "nb export html",        keyword: "nbeh",   snippet: "nb export --format html" },
//     { name: "nb export pdf",         keyword: "nbep",   snippet: "nb export --format pdf" },
//     { name: "nb todos only incomplete", keyword: "nt",  snippet: "nb todos open" },
//   ];
//
//   return {
//     snippets,
